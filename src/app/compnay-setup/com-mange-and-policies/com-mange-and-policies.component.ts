...
@Component({
  selector: 'app-com-mange-and-policies',
  templateUrl: './com-mange-and-policies.component.html',
...
// today: string = '';ta
  ...
  getCompanyData() {
    console.log("hello")
    this.service.post("/company", {}).subscribe((res: any) => {
      this.Companydata = res;
      this.CompanyDetails = this.Companydata.data;
